...
1. **az140-dc-vm11** へのリモート デスクトップ セッション内で、Azure portal を表示している Microsoft Edge ウィンドウに切り替え、ストレージ アカウントが表示されているブレードで **[ファイル共有]** を選び、**[ID ベースのアクセス]** 設定が **[構成済み]** であることを確認します。
